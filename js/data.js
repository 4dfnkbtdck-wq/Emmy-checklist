...
const EMMY_CATEGORIES = [
  ...
  },
  {
    ...
    winners: [
      ...
      { year: 1977, show: "Eleanor and Franklin: The White House Years / Sybil", network: "ABC/NBC" },
      ...
      { year: 1989, show: "Day One / Roe vs. Wade", network: "CBS/NBC" },
      { year: 1990, show: "Caroline? / The Incident", network: "" },
      { year: 1992, show: "Miss Rose White", network: "NBC" },
      { year: 1993, show: "Barbarians at the Gate / Stalin", network: "HBO/TNT" },
